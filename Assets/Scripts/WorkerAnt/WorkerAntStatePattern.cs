...
public class WorkerAntStatePattern : MonoBehaviour {
    ...
    [HideInInspector]
    public IWorkerAntState currentState;
    [HideInInspector]
    public WorkerSearchState searchState;
    [HideInInspector]
    public WorkerReturnState returnState;
    [HideInInspector]
    public WorkerGatherState gatherState;
    [HideInInspector]
    ...
    public void Awake()
    {
        searchState = new WorkerSearchState(this);
        returnState = new WorkerReturnState(this);
        gatherState = new WorkerGatherState(this);
